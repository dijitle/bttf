...
export function drawTimePod(ctx, width, y, color, name, value) {
    ...
    ctx.fillStyle = "#ffffff";
    ctx.fillText(name, width / 2, y + height  - nameFontSize + segThick)
    ...
    draw16SegmentDisplay(ctx, segSeparation, y + labelFontSize + 25 + segThick * 2, segWidth, segHeight, segThick, segGap, months[value.getMonth()][0])
    draw16SegmentDisplay(ctx, segSeparation + segWidth + segThick, y + labelFontSize + 25 + segThick * 2, segWidth, segHeight, segThick, segGap, months[value.getMonth()][1])
    draw16SegmentDisplay(ctx, segSeparation + (segWidth + segThick) * 2, y + labelFontSize + 25 + segThick * 2, segWidth, segHeight, segThick, segGap, months[value.getMonth()][2])
